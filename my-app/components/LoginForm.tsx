...
export default function LoginForm({ onClose }: { onClose?: () => void }) {
  ...
  return (
    <Card className="w-lg h-full rounded-2xl shadow-xl bg-gradient-to-br from-emerald-50 to-emerald-300">
      <CardContent className="p-6 space-y-6">
        ...
        <div>
          <h2 className="text-2xl font-bold text-emerald-900 text-center">Login</h2>
